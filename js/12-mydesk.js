...
function injectMyDeskHeader(){
  ...
  pg.insertAdjacentHTML('afterbegin','<style>#greeting .name{color:#9F6BB5}</style><div style="display:flex;justify-content:space-between;align-items:flex-end;margin:0 0 16px;flex-wrap:wrap;gap:10px"><div><div id="greeting" style="font-size:18px;font-weight:800;color:var(--text,var(--control-text))"></div><div id="subline" style="font-size:12px;color:var(--text3);margin-top:3px"></div></div><div class="u-ta-right"><div id="clock" style="font-size:22px;font-weight:800;color:var(--text,var(--control-text));font-variant-numeric:tabular-nums;line-height:1"></div><div id="datestr" style="font-size:11px;color:var(--text3);margin-top:2px"></div></div></div>');
}
