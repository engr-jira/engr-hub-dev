...
function applyV151Dom(){
  ...
  if(!document.getElementById('v151-style')){
    ...
    st.textContent=`
      ...
      .case-chip.done{color:#3FBE92;background:rgba(34,211,165,.12);border-color:rgba(34,211,165,.25)}.case-chip.open{color:#E8B23D;background:rgba(252,211,77,.10);border-color:rgba(252,211,77,.25)}
