...
function applyV153Dom(){
  try{
    ...
    s.textContent=`
      ...
      .kpi .label{font-size:11px;color:var(--text2);margin-top:7px;font-weight:700}
      ...
      .case-chip.done{border-color:rgba(63,190,146,.32);background:rgba(63,190,146,.1);color:var(--success)}
