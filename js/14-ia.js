...
const IA_GROUPS={dash:'home',mydesk:'home',quiz:'home',quizadmin:'home',customers:'customers',owners:'customers',issues:'issues',cases:'issues',sales:'sales',eos:'sales',vt:'tools',nsischk:'tools',links:'archive',knowledge:'archive',compat:'archive',audit:'admin',monitor:'admin',settings:'admin'};
...
const IA_SUBTABS={
  home:[['dash','대시보드'],['mydesk','My Desk'],['quiz','🧠 퀴즈'],['quizadmin','🛠 퀴즈 관리']],
  customers:[['customers','고객사'],['owners','담당자 관리']],
  issues:[['issues','일반 이슈'],['cases','벤더 케이스']],
  sales:[['sales','영업 현황'],['eos','라이선스']],
  tools:[['vt','VirusTotal 조회'],['nsischk','🧩 NSIS 정합성 검사']],
...
function iaSubtabVisible(page){
  if(page==='quizadmin')return !!((typeof IS_ADMIN!=='undefined'&&IS_ADMIN)||(typeof IS_SUPER!=='undefined'&&IS_SUPER));
